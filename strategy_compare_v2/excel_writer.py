...
class ExcelWriterEngine:
    ...
    def write_sheet(self, dataframe, sheet_name):
        ws = self.writer.create_sheet(title=sheet_name)
    ...
    def reorder_sheets(self):
        ...
        for name in preferred:
            if name in self.writer.sheetnames:
                ordered.append(self.writer[name])
    ...
    def workbook_properties(self):
        ...
        self.writer.properties.keywords = "Strategy Comparison"

        self.writer.calculation = CalcProperties(calcMode="auto")
    ...
    def navigation(self):
        ...
        dashboard["J2"].font = Font(bold=True, color="FFFFFF")

        dashboard["J2"].fill = PatternFill(fill_type="solid", fgColor="4F81BD")

        dashboard["J2"].alignment = Alignment(horizontal="center")
