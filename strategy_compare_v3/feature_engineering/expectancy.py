...
class ExpectancyEngine:
    ...
    def expectancy_quality(self):
        ...
        self.df["Expectancy Quality"] = np.select(
    ...
    def generate(self):
        ...
        logger.info(
            ...
            "Generating Expectancy Features..."
        ...
        logger.info(
            ...
            "Expectancy feature engineering completed."
...
if __name__ == "__main__":
    ...
    print(
        "Import ExpectancyEngine inside feature_engine.py"
    )