...
class OpportunityEngine:
    ...
    def opportunity_efficiency(self):
        ...
        if required.issubset(self.df.columns):
            ...
            self.df["Opportunity Efficiency"] = (
    ...
    def generate(self):
        ...
        logger.info(
            "Generating Opportunity Features..."
        )
        ...
        logger.info(
            "Opportunity feature engineering completed."
        )
