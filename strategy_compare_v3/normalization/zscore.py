...
class ZScoreNormalization:
    ...
    def generate(self):
        logger.info("Running Z-Score Normalization...")
        ...
        normalized[self.numeric_columns] = self.scaler.fit_transform(
        ...
        return pd.DataFrame(
            {
                ...
                "Standard Deviation": np.sqrt(self.scaler.var_),
            }
        )
    ...
    def summary(self):
        return {"Method": "Z-Score", "Features": len(self.numeric_columns)}
