    ...
    def profile(self) -> pd.DataFrame:
        ...
        for column in self.df.columns:
            ...
            profile = {
                ...
                "Duplicate": int(total_rows - s.nunique(dropna=True)),
                ...
                profile.update(
                    {
                        ...
                        "Std Dev": std,
                        "CV %": (
                            std / mean * 100 if pd.notna(mean) and mean != 0 else np.nan
                        ),
                        "Q1": q1,
                        "Q3": q3,
                        "IQR": q3 - q1,
...
if __name__ == "__main__":
    print("Import ColumnProfiler into profiler.py")
