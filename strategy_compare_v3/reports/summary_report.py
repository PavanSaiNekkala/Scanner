...
class SummaryReport:
    ...
    def recommendation_summary(self):
        ...
        summary["Percentage"] = (summary["Count"] / len(self.df) * 100).round(2)

        return summary

    # --------------------------------------------------

    def top_strategies(self, limit: int = 10):
    ...
    def bottom_strategies(self, limit: int = 10):
        if "Composite Score" not in self.df.columns:
            return pd.DataFrame()
    ...
    def generate(self):
        ...
        report = {
            "Dataset Information": self.dataset_information(),
            "Score Summary": self.score_summary(),
            "Recommendation Summary": self.recommendation_summary(),
