...
class CompositeScoreEngine:
    ...
    def generate(self):
        logger.info("Generating Composite Score...")
        ...
        self.df["Composite Score"] = score.clip(0, 100).round(2)

        logger.info("Composite Score completed.")

        return self.df[["Composite Score"]]
