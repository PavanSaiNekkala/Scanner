...
class ExecutionScoreEngine:
    ...
    def generate(self):
        ...
        for feature, weight in self.weights.items():
            ...
            if feature not in self.df.columns:
                ...
                logger.warning(
                    ...
                    "Skipping missing execution feature: %s",
        ...
        logger.info(
            ...
            "Execution Score generated successfully."
...
if __name__ == "__main__":
    ...
    print(
        ...
        "Import ExecutionScoreEngine inside scoring_engine.py"
