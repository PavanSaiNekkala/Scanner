...
class ExitMetrics:
    ...
    def target_capture_ratio(self):
        ...
        self.df["Target Capture"] = safe_divide(
    ...
    def trailing_capture_ratio(self):
        ...
        self.df["Trailing Capture"] = safe_divide(
    ...
    def stop_dependency(self):
        ...
        self.df["Stop Dependency"] = safe_divide(
    ...
    def time_dependency(self):
        ...
        self.df["Time Dependency"] = safe_divide(
    ...
    def exit_stability(self):
        ...
        self.df["Exit Stability"] = safe_divide(
