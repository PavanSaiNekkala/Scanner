...
def filter_composite_score(
    ...
    filtered = df.loc[df[COMPOSITE_SCORE] >= MIN_COMPOSITE_SCORE].copy()
...
def filter_edge_score(
    ...
    filtered = df.loc[df[EDGE_SCORE] >= MIN_EDGE_SCORE].copy()
...
def filter_reliability(
    ...
    filtered = df.loc[df[RELIABILITY_SCORE] >= MIN_RELIABILITY_SCORE].copy()
...
def filter_efficiency(
    ...
    filtered = df.loc[df[EFFICIENCY_SCORE] >= MIN_EFFICIENCY_SCORE].copy()
...
def filter_expectancy(
    ...
    filtered = df.loc[df[EXPECTANCY] >= MIN_EXPECTANCY].copy()
...
def filter_profit_factor(
    ...
    filtered = df.loc[df[PROFIT_FACTOR] >= MIN_PROFIT_FACTOR].copy()
...
def filter_reward_risk(
    ...
    filtered = df.loc[df[REWARD_RISK] >= MIN_REWARD_RISK].copy()
...
def filter_trade_count(
    ...
    filtered = df.loc[df[TRADES] >= MIN_TRADES].copy()
...
def apply_risk_filters(
    ...
    logger.info("Institutional risk filtering completed.")
