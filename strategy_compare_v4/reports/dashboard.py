...
from strategy_compare_v4.reports.charts import (
...
def show_kpis(
    ...
    logger.info("Displaying KPI cards.")
...
def show_recommendations(
    ...
    logger.info("Displaying recommendation summary.")
...
def show_charts(
    ...
    logger.info("Rendering dashboard charts.")
...
def show_portfolio(
    ...
    logger.info("Displaying portfolio allocation.")
...
def run_dashboard():
    ...
    if uploaded is None:
        logger.info("Waiting for user upload.")

        st.info("Upload a comparison report to continue.")
    ...
    try:
        ...
        logger.info("Comparison report loaded successfully.")
        ...
        st.error("Unable to load the comparison report.")
...
if __name__ == "__main__":
    logger.info("Launching Institutional Dashboard.")
